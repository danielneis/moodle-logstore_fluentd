...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox('logstore_newstore/logguests',
    ...
    $settings->add(new admin_setting_configselect('logstore_newstore/loglifetime',
        new lang_string('loglifetime', 'core_admin'),
        new lang_string('configloglifetime', 'core_admin'), 0, $options));

    $settings->add(new admin_setting_configtext('logstore_newstore/buffersize',
        get_string('buffersize', 'logstore_newstore'),
        '', '50', PARAM_INT));
}
